// Kopie aus themes/PaperMod/assets/js/fastsearch.js, damit sie ohne
// Submodul-Patch angepasst werden kann: head.html holt sie ueber
// resources.Get "js/fastsearch.js", und Hugo nimmt assets/ des Projekts
// vor dem Theme. Einziger Unterschied zum Original ist das Argument
// preventScroll an sInput.focus() in initSearch (siehe dort).
// Bei einem Theme-Update neu kopieren und die eine Zeile wieder setzen.
...
const initSearch = async () => {
    ...
    // preventScroll: der Fokus kommt erst, wenn der Suchindex geladen ist.
    // Ohne das Argument scrollt der Browser dann zum Suchfeld, und der
    // Seitenkopf rutscht nach dem ersten Rendern nach oben weg.
