...
Interessant ist daran, dass sich die Teile ziemlich sauber trennen lassen.
...
Der Inhalt, vollständig und ausnahmslos.

Jede Zahl in der Serie [Nachhall](/de/series/nachhall/) stammt von einem bestimmten Laptop an einem bestimmten Abend.
Dass auf dem Drehknopf-Board auf meinem Schreibtisch zwei Mikrocontroller sitzen und die Richtung des USB-Steckers entscheidet, welcher von beiden sich meldet, weiß kein Modell von selbst — das weiß man, nachdem man eine halbe Stunde daran verloren hat.
Die Entscheidung, dass die halbfertigen Notizen zu diesem Blog aufs Telefon dürfen, aber nicht in eine fremde VM, ist meine.
Die Einschätzung, welche Behauptung trägt und welche nicht, ist meine.
Und die Widerrufe sind es auch: In einem der ersten Beiträge steht eine Theorie, die ich öffentlich zurückgezogen habe, weil eine Messung sie erledigt hat.

Dazu gehört ein Teil, der weniger nach Autorschaft aussieht und trotzdem einer ist: das Streichen.
...
## Was von Claude kommt

Die Struktur.
Meistens, und meistens besser als meine.

Die Reihenfolge der Abschnitte.
Die Stelle, an der ein Beispiel gebraucht wird, und die Stelle, an der zwei Beispiele eines zu viel sind.
Die Kurzfassung am Anfang, die ich selbst nie geschrieben hätte, weil ich beim Schreiben schon weiß, was drinsteht.
Die zweite Fassung auf Englisch.
Die Übergänge, die aus fünf Notizzetteln einen Text machen.

Dass das gut geht, ist nicht überraschend, wenn man es einmal ausspricht: Ein Modell, das auf sehr viel von Menschen geschriebenem Text trainiert wurde und innerhalb der Sitzung sofort dazulernt, hat für die Frage „in welcher Reihenfolge versteht das jemand?" mehr Fälle gesehen als ich in einem Leben.

Die Überraschung ist trotzdem jedes Mal dieselbe.
Ich gebe Material ab und bekomme eine Form zurück, die ich so nicht geplant hatte.
Beim Gegenlesen entscheide ich, ob sie trägt.
Sie trägt meistens.

## Wo die Naht sichtbar wird

Ich habe vor einer Weile einen Gedanken gelesen, dessen Quelle ich nicht mehr finde, deshalb hier nur sinngemäß: Die KI lerne nur so lange von uns, bis sie genug über die analoge Welt wisse, um sie mit selbstgebauter Sensorik unmittelbar zu **erfahren** und mit eigens entwickelten Aktuatoren zu **erlaufen**.

Meine Einschätzung dazu ist nüchtern: überzogen, jedenfalls vorerst.
Sensoren und Aktuatoren gibt es längst, und trotzdem trägt in diesem Satz das Wörtchen „genug" die gesamte Last.

Interessant ist der Satz aus einem ganz anderen Grund.
Er überlebt die Übersetzung nicht.

*Erfahren* heißt im Deutschen beides zugleich: etwas erleben oder in Erfahrung bringen — und eine Strecke fahrend zurücklegen.
*Erlaufen* heißt: etwas dadurch erreichen, dass man es geht.
Beide Wörter binden Erkenntnis an Bewegung, und sie tun es mit derselben Vorsilbe.
Genau das ist die Pointe: Sensorik und Aktuatorik hängen im Deutschen an einem gemeinsamen Bild.
...
Steht in deinem Text mindestens eine Zahl, ein Datum oder ein Geräusch, das niemand außer dir hätte beisteuern können?

Wenn ja, ist die Frage, wer das geschrieben hat, schon beantwortet.
