...
- Der Satz klingt nach Werkzeugkunde.
  Er ist eine Aussage über den Bau dieses Blogs: Eine Absicht von mir landet nicht an einer Stelle, sondern an mehreren gleichzeitig.
...
Zwei davon waren keine Textstellen, sondern Verzeichnisse, denn bei Hugo ist der Verzeichnisname die Adresse.
...
Darin steht, wie meine Kürzelliste entstanden ist: nicht geraten, sondern gezählt, aus 764 verschiedenen Nachrichten in 13 Projekten.
...
Dort steht nicht nur die neue Form, sondern auch der Satz, dass der Agent selbst eckig schreiben soll, in Antworten wie in Dokumentation.
...
Es sind deutsche Sätze mit Begründungen, Beispielen und einer Tabelle, und die Begründung wirkt mit — sie erklärt dem Agenten nicht nur, was gilt, sondern warum, und deshalb greift die Regel auch in Fällen, die beim Schreiben niemand vorgesehen hat.
...
Ich habe den Konstruktionsfehler bemerkt — genauer: Er fiel auf, während ich über die Liste sprach, und ich habe entschieden, dass er wichtiger ist als der Beitrag, den ich gerade schrieb.
...
- **Es gibt zwei Sorten Beitrag, und man sieht ihnen den Unterschied nicht an.** Der eine berichtet über etwas außerhalb; der andere ändert das Werkzeug, mit dem der nächste entsteht. Der Chuwi-Laptop gehört zur ersten Sorte, die Kürzel zur zweiten.
