...
- Die allererste Aufgabe an den Agenten enthielt die Werkzeugentscheidung schon.
  Es gab keine Recherche, keinen Vergleich, keine Begründung — es gab einen Namen im Auftrag.
...
- Die Wahl war trotzdem richtig, und ich kann inzwischen sagen, woran ich das festmache — an vier Eigenschaften, die im Alltag tatsächlich getragen haben.
...
Nicht, um die Entscheidung umzuwerfen — sie war gut —, sondern um zu sehen, was „gut" hier überhaupt heißen kann.
...
- **Die Urahnen:** Jekyll (Ruby) — GitHub Pages baut es bis heute ohne Zutun —, Middleman.
...
| npm-Downloads, etwa über npm trends | **Installationen in JavaScript-Projekten** | **gar nicht** — Hugo ist ein Go-Binary und kommt in npm schlicht nicht vor |
...
Die Rangliste misst also nicht Nutzung, sondern **Sichtbarkeit der Nutzung** — und benachteiligt systematisch genau die Generatoren, deren Ergebnis am saubersten ist.
...
**Erstens: schnell.**
Der Build ist keine Wartezeit, sondern ein Tastendruck.
...
Daran hängt dieser Blog vollständig: Deutsch und Englisch sind hier kein Sonderfall, sondern die Grundeinheit, in der jeder Beitrag existiert.
...
Das war kein Kriterium bei der Entscheidung — es ist ein Nebenprodukt, und es ist wertvoller als die meisten Kriterien, die ich hätte aufschreiben können.
