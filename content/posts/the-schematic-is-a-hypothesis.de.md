...
Jedes Mal genau in der Aussage, wegen der man ihn aufgeschlagen hatte.
...
Nicht, dass es wertlos wäre.
Von 23 vermessenen Pins stimmen 20 mit dem Plan überein.
...
Das Datenblatt zum Anzeigetreiber ST77916 ist öffentlich, es liegt nur nicht dort, wo man es sucht.
Der Hersteller des Chips führt es nicht, Espressif schon, unter `dl.espressif.com/AE/esp-iot-solution/ST77916_SPEC_V1.0.pdf`.
...
Der Unterschied zwischen Verblassen und Springen ist damit ein Unterscheidungsmerkmal mit einer Seitenzahl und keine Beobachtungsnuance mehr.
...
Zwei Seiten weiter steht außerdem, dass der Lesebefehl `0x0B` heißt und nicht `0x03`.
`0x03` ist der Lesebefehl von Flash-Speicherbausteinen und auf diesem Chip überhaupt kein Befehl.
...
Die zweite Kette ist die einzige hier, in der **hingesehen** und nicht gesucht wird.
...
Was ihn lesbar macht, ist etwas anderes: Ein Netz, also eine elektrische Verbindung, trägt auf jedem Blatt denselben Namen, und die Arbeit besteht darin, diesen Namen von Blatt zu Blatt zu verfolgen und aufzuschreiben, wo er auftaucht.
